...
- [インセプションデッキ概要](#インセプションデッキ概要)
  - [インセプションデッキの役割はプロジェクトの意思決定のためのツール](#インセプションデッキの役割はプロジェクトの意思決定のためのツール)
  - [インセプションデッキの仕組み](#インセプションデッキの仕組み)
  - [インセプションデッキの設問と課題の一覧](#インセプションデッキの設問と課題の一覧)
- [インセプションデッキ前半はプロジェクトの存在意義について](#インセプションデッキ前半はプロジェクトの存在意義について)
  - [インセプションデッキ1：我々はなぜここにいるのか？(チームのイメージ共有)](#インセプションデッキ1我々はなぜここにいるのかチームのイメージ共有)
  - [エレベーターピッチ(外部へのキャッチコピー)](#エレベーターピッチ外部へのキャッチコピー)
  - [デッキインセプション:パッケージデザインを作る:第三者向け](#デッキインセプションパッケージデザインを作る第三者向け)
  - [デッキインセプション:やらないことリストを作る](#デッキインセプションやらないことリストを作る)
  - [デッキインセプション:ご近所さんを探す](#デッキインセプションご近所さんを探す)
  - [他部署を巻き込めない時にどうするか？](#他部署を巻き込めない時にどうするか)
- [備考](#備考)
